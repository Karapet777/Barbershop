      ...
      <div className="app_about_container">
        ...
        <div className='app-news-container'>
          <div className='app-news-block'>
            ...
            <p className='text'>Нам ноконец завезли ягермайстер! теперь ви можете пропустить стаканчик во время стрижки</p>
            <p>11 ЯНВАРЯ</p>
            <p className='text'>В нашем комаде пополнение, Борис «БРИТВА» Стригунец, обладатель множества титулов и наград пополнил наши стройные ряди  </p>
            <p>18 ЯНВАРЯ</p>
        ...
        <div className='app-news-container'>
          <div className='inp-cont'>
            ...
            <div>
              <p className='about-text size'>адрес:г.цанкт-Петербург,Б.Конушенная,д.19/8</p>
          ...
          <div className='inp-cont'>
            ...
            <p className='text'>Укажите желаемую дату и время и мы свяжемся с вами для подтверждения брони</p>
