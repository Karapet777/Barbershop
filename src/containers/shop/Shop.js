...
const Shop = () => {
  const shop = {
    product: [
      {
        src: img1,
        product: "НАБОР ДЛЯ ПУТЕШЕСТВИЙ",
        productName: "«BAXTER OF CALIFORNIA»",
        cost: "2.900р",
      },
      {
        src: img2,
        product: "Увлажнаущая кондиционер",
        productName: "«BAXTER OF CALIFORNIA»",
        cost: "750р",
      },
      {
        src: img3,
        product: "Гель для волос",
    ...
    productCrem: [
      {
        src: img4,
        product: "Глина для укладки волос",
        productName: "«AMERICAN CREW»",
        cost: "500р",
      },
      {
        src: img5,
        product: "Гел для волос",
        productName: "«AMERICAN CREW»",
        cost: "300р",
      },
      {
        src: img6,
        product: "Набор для бритья",
        productName: "«BAXTER OF CALIFORNIA»",
        cost: "3.900р",
      },
    ],
